      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Bienvenido a cancelmex</h1>
            <p class="lead">Selecciona una pagina, del listado que aparece arriba para comenzar.</p>
          </div>

          <div class="mastfoot">
            <div class="inner">
              <p>Sistema desarrollado por Jorge Rodarte</p>
            </div>
          </div>
