                       ...
                       <?php
                        ...
                        <td>
                            <table class="table" id="tabla_l2">
                                <tr>
                                    <th colspan="2" class="encabezados_tablas"><center><button class="btn btn-defaul" id="boton_menu_l2" onclick="mostrarDisplay_ventana_ante4('tabla_l2','boton_menu_l2')"><span class="glyphicon glyphicon-menu-hamburger"></span></button>Linea 2"</center></th>
                                </tr>
                                ...
                                <tr style="display:none">
                                    ...
                                    $suma_total_l2=$costo_bolsal_l2+$costo_bolsas_l2+$costo_riel_l2+$costo_chapa_l2+$costo_traslape_l2+
                                        ...
                                        $costo_junquillo_l2+$costo_escalonado_l2+$costo_vinil2_l2+$costo_carretilla_l2+$costo_jaladera_l2;
                                    ?>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td><div class="precios"><?php echo round($costo_claro_l2,2); ?></div></td>
                                </tr>
                                <tr>
                                    <td>Chino</td>
                                    <?php
                                    ...
                                    ?>
                                    <td><div class="precios"><?php echo round($costo_chino2_l2,2); ?></div></td>
                                </tr>
                                <tr>
                                    <td>Filtrasol</td>
                                    <?php
                                    ...
                                    ?>
                                    <td><div class="precios"><?php echo round($costo_filtrasol_l2,2); ?></div></td>
                                </tr>
                                <tr>
                                    <td>Tintex</td>
                                    <?php
                                    ...
                                    ?>
                                    <td><div class="precios"><?php echo round($costo_tintex_l2,2); ?></div></td>
                                </tr>
                                <tr>
                                    <td>Satinado</td>
                                    <?php
                        ...
                        <td>
                            <table class="table" id="tabla_l3">
                                <tr>
                                    <th colspan="2" class="encabezados_tablas"><center><button class="btn btn-defaul" id="boton_menu_l3" onclick="mostrarDisplay_ventana_ante4('tabla_l3','boton_menu_l3')"><span class="glyphicon glyphicon-menu-hamburger"></span></button>Linea 3"</center></th>
                                </tr>
                                <tr style="display:none">
                                    <td>Jamba</td><?php
                                ...
                                <tr style="display:none">
                                    ...
                                    $suma_total_l3=$costo_bolsal_l3+$costo_bolsas_l3+$costo_riel_l3+$costo_chapa_l3+$costo_traslape_l3+
                                        ...
                                        $costo_junquillo_l3+$costo_escalonado_l3+$costo_vinil2_l3+
                                        $costo_carretilla_l3+$costo_jaladera_l3;
                                    ?>
