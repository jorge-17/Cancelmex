                       ...
                       <?php
                        ...
                        <td>
                            <table class="table" id="tabla_l2">
                                <tr>
                                    <th colspan="2" class="encabezados_tablas"><center><button class="btn btn-default" id="boton_menu_l2" onclick="mostratDisplay_ventana3('tabla_l2','boton_menu_l2')"><span class="glyphicon glyphicon-menu-hamburger"></span></button>Linea 2"</center></th>
                                </tr>
                                ...
                                <tr style="display:none">
                                    ...
                                    $c=$result->fetch_assoc();
                                    $d=$c['precio'];
                                    $costo_vinil_l2=((($ancho*2)+($alto*6)))*$d;
                                    ?>
                        ...
                        <td>
                            <table class="table" id="tabla_l3">
                                <tr>
                                    <th colspan="2" class="encabezados_tablas"><center><button class="btn btn-default" id="boton_menu_l3" onclick="mostratDisplay_ventana3('tabla_l3','boton_menu_l3')"><span class="glyphicon glyphicon-menu-hamburger"></span></button>Linea 3"</center></th>
                                </tr>
                                <tr style="display:none">
                                    <td>Jamba Lat.</td>
                                    <?php
